---
title: "Project 2 – Classification (Stat897D - Fall 2015)"
...
#### Results summary for training set (interesting but not useful for model selection)
Method: Error rate, Sensitivity, Specificity
Logistic: 28.13%, 45.90%, 85.80%
LDA:      28.26%, 45.90%, 85.60%
QDA:      29.04%, 45.90%, 84.40%
KNN:      24.87%, 53.36%, 86.80%
GAM: 
If validation data is available, then validation results are more relevant
